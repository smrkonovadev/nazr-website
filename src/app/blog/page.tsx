    ...
    <>
      <main className="flex flex-col min-h-screen bg-[#161616] w-full overflow-x-hidden">
        ...
        <section className="w-full flex-1 flex justify-center bg-[#161616] relative z-[70] max-md:mt-0 md:-mt-[48px] max-md:rounded-t-[32px] md:rounded-t-[26px]">
          <DesktopScaler desktopWidth={1440} bgColor="#FFF1EB" className="max-md:rounded-t-[32px] md:rounded-t-[26px]">
            <div
        ...
        <DesktopScaler bgColor="#FFF1EB" className="md:rounded-b-[26px] max-md:rounded-b-[32px] overflow-hidden">
          <div className="relative z-[60] -mt-[1px] bg-[#FFF1EB] w-full md:rounded-b-[26px] max-md:rounded-b-[32px] pb-20">
            <ContactUsSection />
