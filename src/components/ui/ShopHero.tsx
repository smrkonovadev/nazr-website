...
export function ShopHero() {
  return (
    <section className="w-full relative flex flex-col items-center justify-center max-md:pt-0 max-md:-mt-[12px] md:pt-24 max-md:pb-[30px] md:pb-32 px-4 overflow-x-clip min-h-[700px]">

      {/* Universal Scalable Collage */}
      <ScalableShopCollage />

      {/* Bottom Text Elements */}
      <div className="w-full max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-end px-4 md:px-12 max-md:-mt-[100px] md:mt-0 relative z-30 pointer-events-none gap-8 md:gap-0">
