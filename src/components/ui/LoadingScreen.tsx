...
export function LoadingScreen({ onComplete, duration = 3000, autoHide = true }: LoadingScreenProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-screen flex flex-col justify-between px-[30px] py-[28px] sm:px-[40px] sm:py-[32px] md:px-[52px] md:py-[40px] lg:px-[64px] lg:py-[48px]">
        
        {/* ---- TOP ROW ---- */}
        <div className="w-full flex justify-between items-start">
          {/* Top Left: SOS instruction — Bebas Neue */}
          <p
            className="font-normal uppercase text-[#FFF1EB]"
            style={{
          ...
          {/* Top Right: Description — Inter, right-aligned */}
          <p
        ...
        <div className="w-full flex justify-center items-center flex-1">
          <h1
            className="font-normal text-center text-[#F4F0E8] select-none"
            style={{
              fontFamily: "var(--font-bebas), 'Bebas Neue', sans-serif",
        ...
        {/* ---- BOTTOM ROW ---- */}
        <div className="w-full flex items-end justify-between relative" style={{ minHeight: "48px" }}>
          ...
          <div className="shrink-0">
            <svg
              ...
              className="w-[32px] h-[22px] sm:w-[40px] sm:h-[28px] md:w-[48px] md:h-[34px]"
            >
              <path
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-[10px] sm:bottom-[12px] md:bottom-[14px] flex items-center">
            <div
              className="h-[4px] sm:h-[5px] md:h-[6px] overflow-hidden relative"
              style={{
          ...
          <div className="flex items-baseline gap-[6px] sm:gap-[8px] md:gap-[10px] shrink-0">
            <span
              className="font-normal text-[#FFF1EB]"
              style={{
                fontFamily: "var(--font-inter), 'Inter', sans-serif",
