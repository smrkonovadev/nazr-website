    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="absolute z-[5] pointer-events-none max-md:w-[220px] max-md:left-[-10%] max-md:top-[-15%] md:w-[clamp(360px,38vw,540px)] md:left-[-8%] md:top-[-14%]"
          >
            <Image
              unoptimized
              quality={100}
          ...
          >
            ...
            <div
              className="absolute pointer-events-none max-md:w-[220px] max-md:left-[-8%] max-md:top-[-15%] md:w-[clamp(360px,38vw,540px)] md:left-[-8%] md:top-[-14%]"
            >
              <Image
                unoptimized
                quality={100}
