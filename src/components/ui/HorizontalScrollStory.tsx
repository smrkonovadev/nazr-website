...
export function HorizontalScrollStory() {
  ...
  return (
    <section ref={containerRef} className="relative h-[300vh] bg-[#F1E4DE] w-full">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden w-full py-20">
        <motion.div
          ref={trackRef}
          style={{ x }}
        ...
        >
          ...
          <div className="w-[100vw] flex flex-row items-center justify-between flex-shrink-0 pl-[5vw]">
            ...
            <div className="relative max-md:w-[280px] md:w-[500px] lg:w-[600px] h-[60vh] md:h-[85vh] flex-shrink-0 rounded-[16px] overflow-hidden shadow-xl max-md:-mr-[180px] md:-mr-[300px] lg:-mr-[360px] -translate-y-[10px]">
              <Image
          ...
          <div className="flex flex-row items-center gap-x-[10vw] max-md:ml-[calc(180px+10vw)] md:ml-[calc(300px+10vw)] lg:ml-[calc(360px+10vw)] pr-[10vw]">
            ...
            <div className="relative max-md:w-[280px] md:w-[500px] lg:w-[600px] h-[60vh] md:h-[85vh] flex-shrink-0 rounded-[16px] overflow-hidden shadow-xl -translate-y-[10px]">
              <Image
                src="/images/image3.png"
                alt="Woman walking with coffee"
                fill
