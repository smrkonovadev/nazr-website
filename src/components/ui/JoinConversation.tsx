export function JoinConversation() {
  return (
    <section className="w-full bg-transparent flex flex-col items-center justify-center pt-10 pb-10 md:pt-0 md:pb-12 px-4 relative z-20">
      <div className="relative z-10 flex flex-col items-center max-w-[800px] mx-auto text-center">
        <h2
          className="font-[family-name:var(--font-bebas)] font-normal text-[#161616] text-center uppercase max-md:max-w-[336px] max-md:mx-auto text-[46px] md:text-[80px] leading-[90%] tracking-[-0.03em]"
        >
          JOIN THE CONVERSATION.
        </h2>

        <p
          className="font-['Inter',_sans-serif] font-normal text-[#161616] text-center mt-[12px] max-md:max-w-[336px] max-md:mx-auto text-[16px] md:text-[18px] leading-[140%] tracking-[-0.03em] max-w-[600px]"
        >
